...
public class Simon extends JApplet implements MouseListener, Runnable, ActionListener {
	...
	private void jbInit() throws Exception {
		...
		jPanel2.setBounds(new Rectangle(124, 77, 250, 200));
		...
		// colored buttons and interactions
		red.setBackground(new Color(255, 190, 190));
		...
		green.setBackground(new Color(190, 255, 190));
		...
		// start button
		start.setBounds(new Rectangle(15, 300, 84, 51));
		...
		rightWrong.setText("");
		rightWrong.setBounds(new Rectangle(145, 300, 122, 47));
			...
			while (colormix) {
				...
				case 4:
					for (int i = 0; i < 40 && colormix; i++) {
						...
						if (randomcolor == 1)
							changeColors(red, Color.red, new Color(255, 190, 190), time);
						else if (randomcolor == 2)
							changeColors(yellow, Color.yellow, new Color(255, 255, 190), time);
						else if (randomcolor == 3)
							changeColors(green, Color.green, new Color(190, 255, 190), time);
						else if (randomcolor == 4)
							changeColors(blue, Color.blue, new Color(190, 190, 255), time);
					}
					break;
				case 2:
			...
			while (!colormix) {
				...
				while (!correct && !colormix) {
					for (int i = 0; i < numcolors; i++) {
						...
						case RED:
							changeColors(red, Color.red, new Color(255, 190, 190), temps);
							break;
						case YELLOW:
							changeColors(yellow, Color.yellow, new Color(255, 255, 190), temps);
							break;
						case GREEN:
							changeColors(green, Color.green, new Color(190, 255, 190), temps);
							break;
						case BLUE:
							changeColors(blue, Color.blue, new Color(190, 190, 255), temps);
							break;
						}
						try {
							Thread.sleep(100);
